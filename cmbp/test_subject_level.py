...
def test_subject(subject_path, subject_heatmap_path, seed=None):
    ...
    return accuracy_baseline / denominator_baseline, accuracy_knn / denominator_knn, accuracy_random_forest/denominator_random_forest, accuracy_knn_s/ denominator_knn_s, accuracy_random_forest_s/ denominator_random_forest_s, percentage_a, percentage_b, percentage_a_significant, percentage_b_significant


accuracies = {'subject': [], 'method': [], 'accuracy': [], 'percentage_of_data_used_a': [], 'percentage_of_data_used_b': []}
...
for file in os.listdir(folder_path):
    ...
    try:
        ...
        acc_b, acc_knn, acc_rf, acc_knn_s, acc_rf_s, p_a, p_b, p_a_s, p_b_s = test_subject('{}/{}.edf'.format(folder_path, parsed_index), heatmap_path, seed=42)
