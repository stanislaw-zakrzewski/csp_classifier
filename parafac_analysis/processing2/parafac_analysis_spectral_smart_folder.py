...
from parafac_analysis.processing2.parafac_analysis_spectral_smart import adapt_selected_channels, process
    ...
    for file in os.listdir(folder_path):
        ...
        try:
            if file_name.endswith(".edf"):
                ...
                if stage == 2:
                    heatmap = np.load("parafac_analysis/significant_heatmaps2/{}.npy".format(subject_name),
                ...
                if stage == 1:
                    save_file_name = 'significant_heatmaps2/{}'.format(subject_name)
                else:
                    save_file_name = 'significant_heatmaps2_stage_2/{}'.format(subject_name)

                process(subject, selected_frequency_band, selected_channels, selected_labels, starting_rank, end_rank,
                        replicas, iterations, t_min, t_max, save_file_name=save_file_name)
