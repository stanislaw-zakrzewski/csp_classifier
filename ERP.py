...
subject = Subject('preprocessed_subjects\\s01.edf')

# Set parameters and read data
raw_fname = Path(os.path.join(str(data_path), 'MEG\\sample\\sample_audvis_filt-0-40_raw.fif'))
event_fname = Path(os.path.join(str(data_path), 'MEG\\sample\\sample_audvis_filt-0-40_raw-eve.fif'))
tmin, tmax = -0., 1
