...
class CollectData(DoubleScrolledFrame):
    ...
    def open_prompt_window(self):
        ...
        try:
            ...
            print('cannot update timeline plot')
    ...
    def acquisition(self):
        recorded_signal, start_date, channels_in_order = self.bci_interface.run_acquisition(self.prompt_viewer, self.current_queue,
        ...
        self.edf_writer.write(recorded_signal, start_date, self.queue, self.patient_name_value.get(),
                              self.gender_value.get(), channels_in_order)
